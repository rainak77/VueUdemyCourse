<template>
    <form @submit.prevent="submitForm">
        ...
        <div class="form-control" :class="{invalid : !description.isValid}">
            ...
            <textarea id="description" rows="" v-model.trim="description.val" @blur="clearValidity('description')"></textarea>
        ...
        <p v-if="!formIsValid">Please fix the abovce errors and submit again</p>
